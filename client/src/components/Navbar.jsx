        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center gap-8">
             <Link to="/dashboard" className="flex items-center gap-2">
                ...
                <span className="font-bold text-xl text-gray-900 dark:text-white hidden sm:block">CodeIntuit</span>
             </Link>
          ...
          <div className="flex items-center gap-4">
             <ThemeSwitcher />
             <button className="p-2 text-gray-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full relative">
                <Bell size={20} />
             ...
             <div className="relative group">
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-800 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 dark:ring-slate-700 hidden group-hover:block z-50">
                  <button onClick={handleLogout} className="block px-4 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 w-full text-left">
                    Sign out
                  </button>
                </div>
             </div>
